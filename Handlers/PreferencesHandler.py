...
Coordinates shift times, reminders, timezone, and templates handlers.
"""

from .Preferences import ShiftTimesHandler, RemindersHandler, TimezoneHandler, TemplatesHandler
...
class PreferencesHandler:
    ...
    def __init__(self, telegram_client):
        ...
        self.templates_handler = TemplatesHandler(telegram_client)
        ...
        self.handlers = {
            ...
            'templates': self.templates_handler,
        }
    ...
    async def can_handle(self, data: str) -> bool:
        ...
        preference_actions = [
            ...
            "settings_timezone", "settings_templates"
        ]
    ...
    def get_templates_handler(self):
        """Get the templates handler instance."""
        return self.templates_handler
    ...
    async def reset_all_preferences(self, query):
        ...
        await self.templates_handler.reset_templates(query)
    ...
    def get_preferences_summary(self) -> str:
        ...
        templates_summary = self.templates_handler.get_templates_summary()
        summary_parts.append(f"📝 **תבניות:**\n{templates_summary}")
